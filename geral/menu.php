...
<!-- menu.php -->
	...
	<div class="w3-top"   > 
		...
		<div class="w3-bar w3-theme w3-large" style="z-index:-1">
			...
			<a class="w3-bar-item w3-button w3-hide-medium w3-hide-small w3-hover-light-gray w3-padding-16" href="medListar.php" onclick="w3_show_nav('menuMedico')">Pedidos</a>
		</div>
	</div>
	...
	<div class="w3-sidebar w3-bar-block w3-collapse w3-animate-left" style="z-index:3;width:270px" id="mySidebar" >
		...
		<div id="menuMedico" class="myMenu">
			...
			<a class="w3-bar-item w3-button" href="medListar.php">Relação de pedidos</a>
			<a class="w3-bar-item w3-button" href="medIncluir.php">Adicionar um pedido</a>
